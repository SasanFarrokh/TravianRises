...
public class TwoDScrollView extends FrameLayout {
    ...
    private boolean canScroll() {
        ...
        if (child != null) {
            Float childHeight = child.getHeight() * child.getScaleY();
            Float childWidth = child.getWidth() * child.getScaleX();
            return (getHeight() < childHeight.intValue() + getPaddingTop() + getPaddingBottom()) ||
                    (getWidth() < childWidth.intValue() + getPaddingLeft() + getPaddingRight());
        }
        return false;
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
       ...
       */
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    Log.e("sasan", String.valueOf(getChildAt(0).getPivotY()));
                    Log.e("sasan2", String.valueOf("l"));
            }
        }
        return true;
    }
   ...
   /* Offset from child's local coordinates to TwoDScrollView coordinates */
    ...
    private class ScaleListener implements ScaleGestureDetector.OnScaleGestureListener {
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            ...
            //if ( getChildAt(0).getHeight() * mScaleFactor*(1-(mFocusY/getChildAt(0).getHeight())) + getScrollY()  > getBottom()  ) {
                getChildAt(0).setPivotX(mFocusX);
                getChildAt(0).setPivotY(mFocusY);
                getChildAt(0).setScaleX(mScaleFactor);
                getChildAt(0).setScaleY(mScaleFactor);

            //}
            //invalidateChild(getChildAt(0),mTempRect);
            return true;
        }
